...
class AuthUserResource {
  final Dio _dio = Dio();
  final String _loginUrl = "http://soiscan2.mastya.xyz/api/login/";
  final String _refreshTokenUrl = "http://soiscan2.mastya.xyz/api/refresh_token/";
  final String _validateAccessTokenUrl = "http://soiscan2.mastya.xyz/api/checkaccesstoken";
  // final String _validateRefreshTokenUrl = "http://soiscan2.mastya.xyz/api/checkrefreshtoken";
